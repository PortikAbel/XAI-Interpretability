...
from models.ProtoPNet.receptive_field import compute_rf_prototype
from models.ProtoPNet.util.helpers import find_high_activation_crop, makedir
from models.ProtoPNet.util.save import save_image
                ...
                if prototype_self_act_filename_prefix is not None:
                    ...
                    np.save(
                        os.path.join(
                            ...
                            f"{prototype_self_act_filename_prefix}{j}.npz",
                        ),
                        proto_act_img_j,
                    )
